...
if [ -n "${1:-}" ]; then
    ...
    if [[ "$OSTYPE" == "darwin"* ]]; then
        PARAMS_DIR="$HOME/Library/Application Support/LATSParams"
    else
...
function main() {
    ...
    cat <<EOF
LATS - install-params.sh

This script will install the LATS zkSNARK parameters and verify their
