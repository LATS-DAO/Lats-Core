#!/usr/bin/env python3
# Copyright (c) 2020 The LATS Core developers
...
class SaplingMempoolTest(LatsTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 LATS note to Alice
        ...
        # miner sends another 10 LATS note to Alice
