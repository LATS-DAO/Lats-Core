...
from test_framework.test_framework import LatsTier2TestFramework
...
class MasternodeGovernanceBasicTest(LatsTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.lats.org/t/test-proposal",
            2,
