...
# Copyright (c) 2020-2021 The LATS developers
...
class FullBlockTest(LatsTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure latsd isn't accepting b26
        ...
        # Extend the b28 chain to make sure latsd isn't accepting b28
        ...
        # LATS: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the lats code has custom code which does so);
