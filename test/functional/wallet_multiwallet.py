...
Verify that a latsd node can load multiple wallet files
"""
...
class MultiWalletTest(LatsTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w5_info['immature_balance'], 250)
        ...
        for wallet_name, wallet in zip(wallet_names, wallets):
            ...
            assert_equal(info['immature_balance'], 250 if wallet is wallets[0] else 0)
