...
class ListReceivedTest (LatsTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 LATS.
        ...
        # Send 1 LATS to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 LATS sending them all (fee is 0.1 LATS)
        ...
        # Confirm transaction (2 LATS from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 LATS, send 0.6 LATS + 0.05 LATS fee
