...
COIN = 100000000 # 1 LATS in satoshis
...
# Objects that map to latsd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in latsd indicates these should be deserialized as blocks
