...
By default, latsd will dump mempool on shutdown and
...
class MempoolPersistTest(LatsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent latsd from writing mempool.dat to disk. Verify that `savemempool` fails")
