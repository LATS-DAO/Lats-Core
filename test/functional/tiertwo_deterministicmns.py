...
class DIP3Test(LatsTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 LATS) to the operator, and (2 * 2.7 LATS) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid LATS address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid LATS address InvalidPayee", controller.protx_update_registrar,
