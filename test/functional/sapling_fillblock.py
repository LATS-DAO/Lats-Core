...
class SaplingFillBlockTest(LatsTestFramework):
    ...
    def utxo_splitter(self, node_from, n_inputs, node_to):
        ...
        # split each one in 100 (use fixed 0.05 LATS fee)
        for u in utxos:
    ...
    def run_test(self):
        ...
        # Split 10 utxos (of 250 LATS each) in 1000 new utxos of ~2.5 LATS each (to alice)
        UTXOS_TO_SPLIT = 10
        ...
        # Now alice shields the new utxos individually (fixed 0.2 LATS fee --> ~2.3 LATS notes)
