...
lats.conf           | contains configuration settings for latsd or lats-qt
latsd.pid           | stores the process id of latsd while running
...
debug.log           | contains debug information and general logging generated by latsd or lats-qt
