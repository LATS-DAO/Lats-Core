...
The build script we'll be using is contained in the LATS github repository ([contrib/gitian-build.py](https://github.com/lats-project/lats/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the LATS repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/LATS-DAO/Lats-Core/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, lats-detached-sigs, and lats GitHub repos.
