LATS Core version v5.1.0 is now available from:  <https://github.com/lats-project/lats/releases>
...
- #2170 Better lats.conf Masternode data error notification (furszy)
