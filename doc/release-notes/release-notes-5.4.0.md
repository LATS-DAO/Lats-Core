LATS Core version v5.4.0 is now available from: <https://github.com/lats-project/lats/releases>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/lats-project-translations/), and every single person who tested the release candidates.
