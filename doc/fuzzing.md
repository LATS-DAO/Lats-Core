...
To build LATS Core using AFL instrumentation (this assumes that the
...
with certain assembly code from LATS Core's code. See [developer notes on sanitizers](https://github.com/LATS-DAO/Lats-Core/blob/master/doc/developer-notes.md#sanitizers)
