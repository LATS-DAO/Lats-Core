...
{
    const char* pszTimestamp = "2022 LATS Coin - LATS Coin";
...
static MapCheckpoints mapCheckpoints = {
     { 0, uint256S("0000043c6a01c787536012ecc33959ceadc7a270c6e3de8951b8ade35dc56534")},
	 { 250, uint256S("00000023c1ea95c1fb9d3f33a6bdcc7232df38e8d0068c393ef9191d417a5b58")},
	 { 1001, uint256S("6566da2a064972a9a80fcbe6873d8f015eee2966142a897386367d437ab3815d")},
	 { 1051, uint256S("5bacf28c6036263a6f1df6923b1b19f670a7bda2aba365d6234dfb9f1adbfe40")},
	 { 1100, uint256S("1d759b83332500d1c7731687de30826c38071ccba0b333d7a4ab5e1e2061db75")},
	 { 1200, uint256S("c3c03323fbb34533f062fdc59e828043582aaac7b6eea55b613312000337432e")},
	 { 1300, uint256S("b7909e19fac9880e9df82d14c3c7286b250fa1c938122c9369b5ad93859c1e56")},
	 { 31300, uint256S("6f322fce44a95d82e259b0f44ad7be7025a2018fbc2dcc90751721536f67e155")},
	 { 80300, uint256S("e692683226044bc4350ec2605addcecc62ded92753d1465f1dc7a5b771ef9039")},
	 { 123486, uint256S("2ea4ec9c852b8d28d008b3b2c52f0cd96244969261000617c591a51b12675a10")},
};

static const CCheckpointData data = {
    &mapCheckpoints,
    1677022365, // * UNIX timestamp of last checkpoint block
    247209,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1667140000, 2333093, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000043c6a01c787536012ecc33959ceadc7a270c6e3de8951b8ade35dc56534"));
        assert(genesis.hashMerkleRoot == uint256S("0x1bb3ce2f571e68d340a9d40a20ebf824b3a05c351f609d805c1572d42f509b62"));
        ...
        consensus.nMNBlockReward = 6 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "04444ab52455aa424adba975c6fa41a186d006cae6a8d1dcc14b10ea693181bfc1ab3ca3974c593128b6ee29ec4e4c9ba2e68e5b4a6d013489fc4a5c42def8880c";
        consensus.strSporkPubKeyOld = "04b74c05c8d924e2e0343eefb04753bf4b575462948b9c1d343e4429ac7998e3eec16d3e7155744329664ab6934505f1ea6842734b6306afbdee75f0079721377d";
        consensus.nTime_EnforceNewSporkKey = 1677200829;    //!> Friday, February 24, 2023 1:07:09 AM
        consensus.nTime_RejectOldSporkKey = 1677200828;     //!> Friday, February 24, 2023 1:07:08 AM
        ...
        // validation by-pass
        consensus.nLatsBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nLatsBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 1100;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 1200;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 1300;
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 200000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_3].nActivationHeight          = 201000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_5].nActivationHeight          = 202000;
		...
		**/		
		consensus.vUpgrades[Consensus::UPGRADE_BIP65].hashActivationBlock =
                uint256S("0x00000023c1ea95c1fb9d3f33a6bdcc7232df38e8d0068c393ef9191d417a5b58");		
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].hashActivationBlock =
                uint256S("0x1d759b83332500d1c7731687de30826c38071ccba0b333d7a4ab5e1e2061db75");
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].hashActivationBlock =
                uint256S("0xc3c03323fbb34533f062fdc59e828043582aaac7b6eea55b613312000337432e");
        ...
        vSeeds.emplace_back("seed1.lats.cc", true);     // Primary DNS Seeder from Lats
        vSeeds.emplace_back("seed2.lats.cc", true);    // Secondary DNS Seeder from Lats
		vSeeds.emplace_back("188.40.233.39", true);     // Primary DNS Seeder from Lats
        vSeeds.emplace_back("188.40.233.40", true);    // Secondary DNS Seeder from Lats
        vSeeds.emplace_back("188.40.233.41", true);     // Primary DNS Seeder from Lats
        ...
        base58Prefixes[EXT_COIN_TYPE] = {0x80, 0x13, 0x26, 0x79};
        ...
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "ls";
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "lviews";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "latsks";
        bech32HRPs[SAPLING_EXTENDED_SPEND_KEY]   = "l-secret-spending-key-main";
        bech32HRPs[SAPLING_EXTENDED_FVK]         = "lxviews";

        bech32HRPs[BLS_SECRET_KEY]               = "bls-sk";
        bech32HRPs[BLS_PUBLIC_KEY]               = "bls-lk";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("lats-testnet.seed.lats.cc", true);
        vSeeds.emplace_back("lats-testnet.seed2.lats.cc", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet lats addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet lats script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet lats BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet lats BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet lats BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "latsktestsapling";
