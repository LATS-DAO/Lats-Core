...
#error Client version information missing: version is not defined by lats-config.h or in any other way
#endif
...
/**
 * latsd-res.rc includes this file, but it cannot cope with real c++ code.
