...
/** Utility functions used by the LATS Qt UI.
 */
namespace GUIUtil
{
...
// Render LATS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZlats = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZlats = false);
...
// Parse "lats:" URI into recipient object, return true on successful parsing
