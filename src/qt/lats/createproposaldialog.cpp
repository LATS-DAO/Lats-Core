...
#include "qt/lats/createproposaldialog.h"
#include "qt/lats/forms/ui_createproposaldialog.h"

#include "qt/lats/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(LATSGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.lats/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 LATS");
