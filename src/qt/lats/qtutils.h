...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, LATSGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, LATSGUI* gui, double posX = 3);
