...
#include "qt/lats/settings/settingsnetworkwidget.h"
#include "qt/lats/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/lats/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(LATSGUI* _window, QWidget *parent) :
