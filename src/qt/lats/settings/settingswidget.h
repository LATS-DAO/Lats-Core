...
#include <QWidget>
#include "qt/lats/pwidget.h"
#include "qt/lats/settings/settingsbackupwallet.h"
#include "qt/lats/settings/settingsexportcsv.h"
#include "qt/lats/settings/settingsbittoolwidget.h"
#include "qt/lats/settings/settingssignmessagewidgets.h"
#include "qt/lats/settings/settingswalletrepairwidget.h"
#include "qt/lats/settings/settingswalletoptionswidget.h"
#include "qt/lats/settings/settingsmainoptionswidget.h"
#include "qt/lats/settings/settingsdisplayoptionswidget.h"
#include "qt/lats/settings/settingsinformationwidget.h"
#include "qt/lats/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(LATSGUI* parent);
    ~SettingsWidget();
