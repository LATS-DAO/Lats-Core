...
#include "qt/lats/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/lats/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(LATSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to LATSGUI::handleRestart()
