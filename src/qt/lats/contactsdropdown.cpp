...
#include "qt/lats/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, LATSGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
