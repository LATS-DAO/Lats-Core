...
#ifndef LATS_CORE_NEW_GUI_LATSGUI_H
#define LATS_CORE_NEW_GUI_LATSGUI_H
...
#include "qt/lats/navmenuwidget.h"
#include "qt/lats/topbar.h"
#include "qt/lats/dashboardwidget.h"
#include "qt/lats/send.h"
#include "qt/lats/receivewidget.h"
#include "qt/lats/addresseswidget.h"
#include "qt/lats/coldstakingwidget.h"
#include "qt/lats/governancewidget.h"
#include "qt/lats/masternodeswidget.h"
#include "qt/lats/snackbar.h"
#include "qt/lats/settings/settingswidget.h"
...
/**
  LATS GUI main class. This class represents the main window of the LATS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LATSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LATSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~LATSGUI();
...
#endif //LATS_CORE_NEW_GUI_LATSGUI_H
