...
#include "qt/lats/sendcustomfeedialog.h"
#include "qt/lats/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(LATSGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &LATSGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
