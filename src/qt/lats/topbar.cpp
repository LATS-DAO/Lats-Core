...
#include "qt/lats/topbar.h"
#include "qt/lats/forms/ui_topbar.h"
#include "qt/lats/lockunlock.h"
#include "qt/lats/qtutils.h"
#include "qt/lats/receivedialog.h"
#include "qt/lats/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/lats/balancebubble.h"
...
TopBar::TopBar(LATSGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopLats, ui->labelAmountTopShieldedLats}, "amount-small-topbar");
    setCssProperty({ui->labelAmountLats}, "amount-topbar");
    setCssProperty({ui->labelPendingLats, ui->labelImmatureLats}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // LATS Total
    QString totalLats = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // LATS
    // Top
    ui->labelAmountTopLats->setText(totalTransparent);
    ui->labelAmountTopShieldedLats->setText(totalShielded);
    // Expanded
    ui->labelAmountLats->setText(totalLats);
    ui->labelPendingLats->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureLats->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
