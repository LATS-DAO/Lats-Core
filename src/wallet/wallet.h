...
#ifndef LATS_WALLET_H
#define LATS_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_LATS = 61000, // inherited version..
...
public:
     ...
     * LATS: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 LATS output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CLatsStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
